...
describe Product do
  ...
  describe ".search" do
    ...
    context "when searching for title 'videogame' and '100'" do
    ...
    context "when searching for title 'tv', '150' as max price & '50' as min price" do
      it "returns the appropriate product" do
